...
#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
#define PLL_N      360		/* Slowed down for USB configuration; Default = 360 */
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      2
#endif /* STM32F427_437x || STM32F429_439xx */
...
#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
  uint32_t SystemCoreClock = 180000000;	/* Slowed down for USB configuration; Default = 180 000 000 */
#endif /* STM32F427_437x || STM32F429_439xx */
